    ...
    for j in range(int(repetitions)):
        ...
        while not match:
            ...
            if gene_1 in dominant:
                idx = dominant.index(gene_1)
                gene_1_location = 'dom'

            else:
                idx = recessive.index(gene_1)
                gene_1_location = 'rec'

            if gene_1_location == 'dom' and recessive[idx] == gene_2 or gene_1_location == 'rec' and dominant[idx] == gene_2:
                print('match found!')
                match = True
